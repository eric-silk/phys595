...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \includegraphics[height=0.75\textheight]{img/da_paper.png}
            \end{figure}
        \end{column}
    \end{columns}
...
\begin{frame}
    ...
    \note[item]{AC due to passive transformers enabling stepping up/down voltages to minimize losses}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                ...
                \item ``Droop'' control -- power output droops as frequency increases
            ...
            $S_{rated}$ is the rated apparent power.
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{figure}[h]
                \vspace{-10pt}
...
\end{frame}
\begin{frame}
    \frametitle{Basic Visualization of the Analogy}
    \begin{figure}[h]
...
\begin{frame}
    ...
    Several numerical results are presented, all of which are as expected. This example is
    a simulation of changing the block setpoint (or power reference).
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}[h]
                \includegraphics[width=0.9\textwidth]{img/numerical1.png}
                \caption{Water Level (cm) vs time (s)\cite{synch_machine}}
            \end{figure}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{figure}[h]
                \includegraphics[width=0.9\textwidth]{img/numerical2.png}
                \caption{Water Volume (cm$^3$) vs time (s)\cite{synch_machine}}
            \end{figure}
        \end{column}
    \end{columns}
